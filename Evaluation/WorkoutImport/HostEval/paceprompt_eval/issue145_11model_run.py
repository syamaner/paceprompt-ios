"""Separately authorised, serial issue #145 eleven-model matrix execution.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Exact-authorisation issue #145 matrix runner")
