...
- The local storage contract keeps saved plans, future execution summaries and deliberately ephemeral data separate. History, reset, recovery UI, recovery-byte export and complete-store/history export remain deferred.
